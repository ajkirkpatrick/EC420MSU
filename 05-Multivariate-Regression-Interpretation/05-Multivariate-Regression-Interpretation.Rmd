...
```{r DegFC, echo=F, include=T, out.width='70%'}
df = tibble(F = 0:120,
                C = (F-32)*(5/9))
...
```{r WooldridgeHomoskedasticity, echo=F, include=T, fig.align = 'center', fig.cap='Homoskedasticity (from Wooldridge)', out.width='75%'}
