...
output:
  xaringan::moon_reader:
    lib_dir: libs
    yolo: false
    css: [metropolis-fonts, default, metropolis, ajk_css]
    nature: 
...
knitr::kable(df, format='latex', align = 'cc') %>% 
  ...
  as_image(height =3, file = 'exDeviationsFromMeanTable.png')
...
knitr::include_graphics('Table C-2.jpg')
```
...
include_graphics('Figure C-4.jpg')
```
...
include_graphics('Table G-2.jpg')
```
...
include_graphics('Figure C-6.jpg')
```
