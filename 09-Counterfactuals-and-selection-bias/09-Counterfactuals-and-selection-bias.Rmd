...
knitr::include_graphics('figs/MMTbl13.png')
```
...
include_graphics('figs/MMTbl13.png')
```
...
http://www.justinkirkpatrick.com/EC420MSU/09-Counterfactuals-and-selection-bias/MMTbl13.png
