...
### Recall on Monday we:
- Covered continuous $\times$ continuous interactions
...
- Introduced the Instrumental Variable (IV)
  ...
  - The IV gives us independent (or *exogenous*) variation in $D$.
...
Since $w$ is uncorrelated with things correlated with $Z$, $\phi_1$ is unbiased.
...
And the estimate of $\beta_1$ here is our IV estimate: $\hat{\beta}_1^{IV}$. That is our coefficient of inerest!
