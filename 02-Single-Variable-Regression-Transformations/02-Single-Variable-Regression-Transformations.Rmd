...
```{r Wooldridge0k, echo=F, include=T, out.width='90%'}
...
- "One additional year of education is associated with a `r round(dlm$coefficients[2], 2)` increase in expected monthly earnings, all else held equal"
...
```{r quadraticExample, echo=F, include=T, fig.width=6, fig.height=1.4}
...
### First, data
There is a very helpful packages called "wooldridge" that you can install with `install.packages('wooldridge')`. Then, we can use R's built-in "data" function to load `wage2`
