...
# 
# require(pagedown)
# pagedown::chrome_print(input = gsub(pattern = '\\.Rmd', replacement = '.html', rstudioapi::getSourceEditorContext()$path),
#                    output = gsub(pattern = '\\.Rmd', replacement = '.pdf', basename(rstudioapi::getSourceEditorContext()$path)),
#                    #wait = 3,
#                    timeout = 300,
#                    format = 'pdf')
...
currentfile = gsub(pattern='\\.Rmd', '', (rstudioapi::getSourceEditorContext()$path))
pagedown::chrome_print(input = paste0(currentfile, '.html'),
                   output = paste0(basename(currentfile), '.pdf'),
                   #wait = 3,
                   timeout = 300,
                   format = 'pdf')
